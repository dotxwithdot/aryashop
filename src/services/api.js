...
export function normalizeProduct(product) {
  ...
  return {
    ...
    highlights: product.highlights?.length ? product.highlights : [product.material, "Easy WhatsApp inquiry"].filter(Boolean),
    shipping: product.shipping || "Ships in 3-6 working days.",
    badgeLabel: product.badgeLabel || "Best Seller",
    rating: product.rating || 4.5,
    reviews: product.reviews || 0,
    reviewSummary: product.reviewSummary || "Customers love the comfort, styling, and easy WhatsApp support from AryaShop.",
